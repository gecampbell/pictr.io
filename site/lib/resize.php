...
class Resize {
	...
	/**
	 * constructor - save, verify the image file
	 */
...
error_log("Unexpected type: $type");
	...
	/**
	 * this actually performs the resizing
	 */
	...
	/**
	 * determines the dimensions for various types
	 */
	...
	private function crop($optimalWidth, $optimalHeight, $newWidth, $newHeight)
	{
		...
		imagecopyresampled($this->imageResized,
			$crop , 0, 0, $cropStartX, $cropStartY,
